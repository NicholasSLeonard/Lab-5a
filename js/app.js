...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  //console.log([sum(sum(a,b)[0],c)[0], multiply(multiply(a,b)[0],c), (a + ' and ' + b + ' and ' + c + ' sum to ' + sum(sum(a,b),c) + '.'), ('The product of ' + a + ' and ' + b +' and ' + c +' is ' + multiply(multiply(a,b),c) + '.')]);
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  //console.log([sumNum, sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sumNum + ' is their sum.']);
  return[sumNum, sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sumNum + ' is their sum.'];
}
